...
6. Compare warm Qwen3 0.6B reranking against `score_plus_created_at_rank_close_margin` on multi-result live searches; after that, add the ONNX/Transformers.js bridge or BGE reranker MLX proof.
