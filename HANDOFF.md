...
- Direct MLX prompt/continuation loglikelihood harnesses now exist at
  ...
  plumbing only; `lm-eval-selected` remains blocked until a non-mock Qwen3 v4
  adapter run scores selected task documents from MLX logits.
  See `reports/benchmark/lm-eval/mlx-loglikelihood-direct-smoke-20260526.md`.
