...
- Model radar includes Qwen3.6, Hermes 4.3, Gemma 4 12B/26B/31B, MiniCPM-o 4.5, Granite 4.1, Command A+, Step 3.7 Flash, DeepSeek-V4-Flash, Nex-N2-mini, Nemotron 3.5 safety/ASR support, the Nemotron frontier teacher/reward set, LFM2.5, LFM2-ColBERT, Qwen3-Next, BitNet, BGE-M3, Jina embeddings, and watchlist entries for RWKV/Mamba-style families.
