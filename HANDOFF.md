...
6. Build a live read-only Qwen3 0.6B reranker wrapper and prove latency against real `mem0 search` output; then add the ONNX/Transformers.js bridge or BGE reranker MLX proof.
