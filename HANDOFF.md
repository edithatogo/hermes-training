...
6. Create an isolated non-sensitive multi-result mem0 fixture store or replay harness, then compare warm Qwen3 0.6B reranking against `score_plus_created_at_rank_close_margin`; after that, add the ONNX/Transformers.js bridge or BGE reranker MLX proof.
