...
- Model radar includes Qwen3.5-27B, Qwen3.6-27B, Qwen3.6-35B-A3B, Hermes 4.3, Gemma 4 12B/26B/31B, MiniCPM-o 4.5, MiniCPM-V-4.6, MiniCPM-V-4.6-Thinking, MiniCPM-SALA, AgentCPM-Report, Nanbeige4.1-3B, DiffusionGemma plus NVIDIA/MLX packaging, Granite 4.1, Command A+, Step 3.7 Flash, DeepSeek-V4-Flash, Nemotron-Labs-Diffusion, Nex-N2-mini, Nemotron 3.5 safety/ASR support, the Nemotron frontier teacher/reward set, LFM2.5, LFM2-ColBERT, Qwen3-Next, BitNet, BGE-M3, Jina embeddings, and watchlist entries for RWKV/Mamba-style families.
