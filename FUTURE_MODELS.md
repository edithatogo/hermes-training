...
2026-06-12 refresh: the refreshed BGE-M3 baseline on the tiny 3-case mem0 retrieval suite landed at top-1 0.667 / recall@3 1.000, the close-margin reranker replay held at 1.000 on the fixed suite and 0.917 on the nomic-expanded replay, and `google/embeddinggemma-300m` is currently access-blocked by a Hugging Face 403 rather than runtime behavior.
