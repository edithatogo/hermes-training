...
2026-06-13 refresh: EmbeddingGemma GGUF passed both direct `llama-embedding` and `llama-server` OpenAI-compatible differentiation runs at top-1 1.000 / recall@3 1.000. The live output-local mem0 fixture reached top-1 0.909 / recall@3 1.000, and captured fixture replay showed the remaining miss is reranker policy: vector replay reproduced 0.909 while `query_terms_guarded` replay reached 1.000. Keep EmbeddingGemma non-default until a fresh live fixture with the guarded reranker passes.
