...
- Blocker: Kaggle kernel version 5 completed without scores; the recovered summary is blocked, and this P100 path now needs a runner/runtime change or a different backend.
- Operator actions:
  - Keep the recovered version 5 failed summary on the SSD as non-promotional evidence.
