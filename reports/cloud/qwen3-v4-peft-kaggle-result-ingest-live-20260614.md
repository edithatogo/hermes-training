...
Status: `fail`
Summary JSON: `/Volumes/PortableSSD/hermes-evals/kaggle/qwen3-v4-peft-lm-eval-selected-full-20260614/qwen3-v4-peft-kaggle-lm-eval-20260613-173501-summary.json`
...
| Check | Result | Detail |
|---|---|---|
| `summary_on_storage_root` | `pass` | /Volumes/PortableSSD/hermes-evals/kaggle/qwen3-v4-peft-lm-eval-selected-full-20260614/qwen3-v4-peft-kaggle-lm-eval-20260613-173501-summary.json |
...
| `output_dir_on_storage_root` | `fail` | /kaggle/working/qwen3-v4-peft-kaggle-lm-eval-20260613-173501-lm-eval-output |
