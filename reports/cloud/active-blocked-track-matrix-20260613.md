...
| `qwen3-v4-peft-colab-full-scorecard_20260613` | `colab` | `ready` | No-limit PEFT scorecards were pruned before artifacts were recovered. | Download JSON and harness result artifacts. |
| `qwen3-v4-peft-colab-scorecard-shards_20260613` | `colab` | `ready` | No-limit PEFT scorecards were pruned before artifacts were recovered. | Run and recover `truthfulqa_mc2`. |
