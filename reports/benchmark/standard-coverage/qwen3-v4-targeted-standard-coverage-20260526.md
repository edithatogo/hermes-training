...
| `lm-eval-selected` | official-candidate | `missing` |  | reports/benchmark/lm-eval/qwen3-4b-v4-targeted-mlx-direct-lm-eval-selected-limit25-20260526.md | general benchmark claim |
