# Standard Benchmark Coverage: qwen3-4b-strict-toolcall-v6-free-text-copy

Run ID: `qwen3-v6-free-text-copy-standard-coverage-20260613`
Status: `pilot-only`
...
|---|---|---|---|---|---|
| `local-heldout-strict-tool-call` | candidate-local | `passed` | strict held-out pass 1.000; mirrored strict pass 1.000 | reports/benchmark/local-pilots/qwen3-4b-strict-toolcall-v6-free-text-copy-local-pilots-20260613.md | local adapter publication claim |
...
| `lm-eval-selected` | official-candidate | `missing` |  | reports/benchmark/lm-eval/qwen3-4b-v4-targeted-mlx-direct-lm-eval-selected-seq-20260610.md | general benchmark claim |
