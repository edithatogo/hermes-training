...
Date: 2026-06-12T14:22:09.294727+00:00
Run ID: embedding-bge-m3-differentiation-20260613
Summary: `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/embedding-bge-m3-differentiation-20260613/summary.json`
...
| Output | `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/embedding-bge-m3-differentiation-20260613` |
...
| Metric | Value |
|---|---:|
| Pass rate / top-1 accuracy | 0.900 |
| Rerank pass rate |  |
| Recall@k / Recall@3 | 1.000 |
| Top-1 expected rate | 0.900 |
| Recency conflict pass rate |  |
| Distractor resistance pass rate |  |
| JSON validity rate |  |
| Add latency p50 |  |
| Search/embed/extract latency p50 | 0.109 |
| Search/embed/extract latency p95 | 0.137 |
| Rerank latency p50 |  |
