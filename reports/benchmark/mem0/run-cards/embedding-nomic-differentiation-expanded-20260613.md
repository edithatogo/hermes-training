...
Date: 2026-06-12T23:43:52.802827+00:00
Run ID: embedding-nomic-differentiation-expanded-20260613
Summary: `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/embedding-nomic-differentiation-expanded-20260613/summary.json`
...
| Output | `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/embedding-nomic-differentiation-expanded-20260613` |
...
| Metric | Value |
|---|---:|
| Pass rate / top-1 accuracy | 0.714 |
| Rerank pass rate |  |
| Recall@k / Recall@3 | 0.857 |
| Top-1 expected rate | 0.714 |
| Recency conflict pass rate |  |
| Distractor resistance pass rate |  |
| JSON validity rate |  |
| Add latency p50 |  |
| Search/embed/extract latency p50 | 0.020 |
| Search/embed/extract latency p95 | 0.035 |
| Rerank latency p50 |  |
