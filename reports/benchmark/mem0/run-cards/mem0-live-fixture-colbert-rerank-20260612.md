...
Date: 2026-06-12T13:54:20.378118+00:00
Run ID: mem0-live-fixture-colbert-rerank-20260612
Summary: `/Volumes/PortableSSD/hermes-evals/mem0-isolated-fixture-rerank/mem0-live-fixture-colbert-rerank-20260612/summary.json`
...
| Endpoint | |
| Collection or index | `mem0_fixture_mem0_live_fixture_colbert_rerank_20260612` |
| Embedding dims |  |
| Distance metric | cosine / configured vector-store metric |
| Output | `/Volumes/PortableSSD/hermes-evals/mem0-isolated-fixture-rerank/mem0-live-fixture-colbert-rerank-20260612` |
...
| JSON validity rate |  |
| Add latency p50 | 2.891 |
| Search/embed/extract latency p50 | 2.893 |
