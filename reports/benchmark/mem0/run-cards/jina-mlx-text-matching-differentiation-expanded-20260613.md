...
Date: 2026-06-12T23:44:00.042491+00:00
Run ID: jina-mlx-text-matching-differentiation-expanded-20260613
Summary: `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/jina-mlx-text-matching-differentiation-expanded-20260613/summary.json`
...
| Output | `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/jina-mlx-text-matching-differentiation-expanded-20260613` |
...
| Metric | Value |
|---|---:|
| Pass rate / top-1 accuracy | 0.786 |
| Rerank pass rate |  |
| Recall@k / Recall@3 | 0.929 |
| Top-1 expected rate | 0.786 |
| Recency conflict pass rate |  |
| Distractor resistance pass rate |  |
| JSON validity rate |  |
| Add latency p50 |  |
| Search/embed/extract latency p50 | 0.026 |
| Search/embed/extract latency p95 | 0.033 |
| Rerank latency p50 |  |
