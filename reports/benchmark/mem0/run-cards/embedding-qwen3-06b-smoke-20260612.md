...
Run ID: embedding-qwen3-06b-smoke-20260612
Summary: `/Volumes/PortableSSD/hermes-evals/embedding-benchmark/embedding-qwen3-06b-smoke-20260612/summary.json`
...
|---|---|
| Role | embedder |
| Model/tool | `Qwen/Qwen3-Embedding-0.6B` |
...
| JSON validity rate |  |
| Add latency p50 |  |
| Search/embed/extract latency p50 | 0.192 |
| Search/embed/extract latency p95 | 1.231 |
| Rerank latency p50 |  |
