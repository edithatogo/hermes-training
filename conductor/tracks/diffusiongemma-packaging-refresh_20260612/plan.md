# Plan: DiffusionGemma Packaging Refresh

## Phase 1: Source Verification

- [x] Task: verify the current published status of the packaging variants.

## Phase 2: Repository Sync

- [x] Task: update `MODEL_CANDIDATES.yaml` with the verified candidates.
- [x] Task: update `FUTURE_MODELS.md` with the packaging note.
