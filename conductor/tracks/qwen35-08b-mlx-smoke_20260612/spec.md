# Specification: Qwen3.5 0.8B MLX Smoke

Prove the smallest Qwen3.5 candidate can be acquired to the SSD-backed Hugging
Face cache and loaded through the direct MLX loglikelihood smoke harness.

Acceptance criteria:

- Run a bounded one-case loglikelihood smoke for `Qwen/Qwen3.5-0.8B`.
